...
const Index = () => {
  ...
  const steps = [
    { icon: 'UserPlus', title: 'Регистрация', desc: 'Создайте бесплатный аккаунт за 30 секунд' },
    { icon: 'Wallet', title: 'Пополнение счета', desc: 'Внесите от $10 любым удобным способом' },
    { icon: 'BookOpen', title: 'Обучение', desc: 'Пройдите бесплатные курсы трейдинга' },
    { icon: 'TrendingUp', title: 'Торговля', desc: 'Начните зарабатывать на бинарных опционах' },
  ];

  const benefits = [
    { icon: 'Shield', title: 'Лицензия IFMRRC', desc: 'Регулируемый брокер с международной лицензией' },
    { icon: 'Zap', title: 'Быстрый вывод', desc: 'Вывод средств за 24 часа без задержек' },
    { icon: 'Award', title: 'Бонусы до 100%', desc: 'Щедрые бонусы на первый депозит' },
    { icon: 'Smartphone', title: 'Мобильное приложение', desc: 'Торгуйте в любом месте с iOS/Android' },
    { icon: 'HeadphonesIcon', title: 'Поддержка 24/7', desc: 'Русскоязычная поддержка круглосуточно' },
    { icon: 'BarChart3', title: 'До 98% прибыли', desc: 'Высокая доходность на валютных парах' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0A0E1A] via-[#0F1419] to-[#0A0E1A]">
        ...
        <div className="container mx-auto max-w-6xl relative z-10 animate-fade-in">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Pocket Option — международный брокер с лицензией IFMRRC. Быстрый старт, низкий порог входа, вывод за 24 часа
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="bg-gradient-to-r from-primary to-secondary text-black font-bold text-lg px-8 py-6 hover:scale-105 transition-transform animate-pulse-glow">
                Начать торговать
          ...
          <div className="mt-16 flex justify-center gap-12 text-sm">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-secondary mb-1">$120M+</div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, idx) => (
              <Card key={idx} className="p-6 bg-card/50 backdrop-blur border-white/10 hover:border-primary/50 transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: `${idx * 0.1}s` }}>
                <div className="w-14 h-14 bg-gradient-to-br from-primary to-secondary rounded-xl flex items-center justify-center mb-4">
                  <Icon name={step.icon as any} className="text-black" size={28} />
                </div>
                <div className="text-sm text-secondary font-semibold mb-2">Шаг {idx + 1}</div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-transparent via-primary/5 to-transparent">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">
            Почему выбирают <span className="text-secondary">Pocket Option</span>
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, idx) => (
              <Card key={idx} className="p-6 bg-card/50 backdrop-blur border-white/10 hover:border-secondary/50 transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: `${idx * 0.1}s` }}>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-center text-muted-foreground mb-12">Минимальный депозит — $10. Вывод от $10 за 24 часа</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {methods.map((method, idx) => (
              <Card key={idx} className="p-6 bg-card/50 backdrop-blur border-white/10 text-center hover:border-primary/50 transition-all hover:scale-105">
                <Icon name={method.icon as any} className="mx-auto text-primary mb-3" size={40} />
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-transparent via-secondary/5 to-transparent">
        <div className="container mx-auto max-w-5xl">
          ...
          <p className="text-center text-muted-foreground mb-12">Данные обновляются в реальном времени</p>
          <Card className="p-8 bg-gradient-to-br from-card/80 to-card/50 backdrop-blur-xl border-white/10">
            <div className="flex justify-between items-start mb-6">
              <div>
                <div className="text-sm text-muted-foreground mb-1">EUR/USD</div>
                <div className="text-4xl font-bold flex items-center gap-3">
                  {price.toFixed(4)}
                  <span className={`text-lg ${isUp ? 'text-primary' : 'text-red-500'}`}>
                    {isUp ? '▲' : '▼'}
                  </span>
                </div>
              </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-sm text-muted-foreground mb-1">Потенциальная прибыль</div>
                <div className="text-2xl font-bold text-primary">+92%</div>
              </div>
              <div>
                <div className="text-sm text-muted-foreground mb-1">Ваша ставка</div>
                <div className="text-2xl font-bold">$50</div>
              </div>
              <div>
                <div className="text-sm text-muted-foreground mb-1">Возможный доход</div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground">support@pocketoption.com</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground">Круглосуточно, без выходных</span>
                </div>
                <div className="flex items-center gap-2">
                  <Icon name="Globe" className="text-secondary" size={16} />
                  <span className="text-muted-foreground">Русскоязычная поддержка</span>
                </div>
              </div>
            </div>
          </div>
          <div className="pt-8 border-t border-white/5 text-center text-sm text-muted-foreground">
            <p>© 2024 Pocket Option. Торговля финансовыми инструментами сопряжена с рисками. Инвестируйте с осторожностью.</p>
          </div>
        </div>
      </footer>
    </div>
